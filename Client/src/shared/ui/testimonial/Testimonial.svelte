...
<article>
    {#if quoteSvg}
        <svg fill="none" height="102" viewBox="0 0 104 102" width="104" xmlns="http://www.w3.org/2000/svg">
    ...
    <figure>
        <figcaption>
            <div>
                <enhanced:img alt="{authorImageAlt}" src="{authorImageSrc}"/>
                <div>
                    <cite>{authorFullName}</cite>
