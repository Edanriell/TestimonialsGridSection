<script lang="ts">
    ...
    const testimonials = [
        {
            authorImageSrc: "images/raster/authors/Daniel_Clifford.jpg",
            authorImageAlt: "Daniel Clifford",
            authorFullName: "Daniel Clifford",
            authorOccupation: "Verified Graduate",
        ...
        {
            authorImageSrc: "images/raster/authors/Jonathan_Walters.jpg",
            authorImageAlt: "Jonathan Walters",
            authorFullName: "Jonathan Walters",
            authorOccupation: "Verified Graduate",
        ...
        },
        {
            ...
            authorImageAlt: "Jeanette Harmon",
            authorFullName: "Jeanette Harmon",
            authorOccupation: "Verified Graduate",
        ...
        },
        {
            ...
            authorImageAlt: "Kira Whittle",
            authorFullName: "Kira Whittle",
            authorOccupation: "Verified Graduate",
        ...
        },
        {
            ...
            authorImageAlt: "Patrick Abrams",
            authorFullName: "Patrick Abrams",
            authorOccupation: "Verified Graduate",
    ...
    const testimonialsLayout = [
        {
            mobile: "row-start-1 row-end-2",
            tablet: "tablet:row-start-1 tablet:row-end-2 tablet:col-start-1 tablet:col-end-[-1]",
            desktop: "desktop:col-start-1 desktop:col-end-3 desktop:row-start-1 desktop:row-end-2"
        },
        {
            mobile: "row-start-2 row-end-3",
            tablet: "tablet:row-start-2 tablet:row-end-3 tablet:col-start-1 tablet:col-end-2",
            desktop: "desktop:col-start-3 desktop:col-end-4 desktop:row-start-1 desktop:row-end-2"
        },
        {
            mobile: "row-start-3 row-end-4",
            tablet: "tablet:row-start-2 tablet:row-end-3 tablet:col-start-2 tablet:col-end-3",
            desktop: "desktop:col-start-1 desktop:col-end-2 desktop:row-start-2 desktop:row-end-3"

        },
        {
            mobile: "row-start-5 row-end-7",
            tablet: "tablet:row-start-4 tablet:row-end-5 tablet:col-start-1 tablet:col-end-[-1]",
            desktop: "desktop:col-start-4 desktop:col-end-5 desktop:row-start-1 desktop:row-end-3"
        },
        {
            mobile: "row-start-4 row-end-5",
            tablet: "tablet:row-start-3 tablet:row-end-4 tablet:col-start-1 tablet:col-end-[-1]",
            desktop: "desktop:col-start-2 desktop:col-end-4 desktop:row-start-2 desktop:row-end-3"
        }
    ];
</script>
